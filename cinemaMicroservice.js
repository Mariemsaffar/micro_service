...
// Charger le fichier cinema.proto
const cinemaProtoPath = 'cinema.proto';
const cinemaProtoDefinition = protoLoader.loadSync(cinemaProtoPath, {
keepCase: true,
longs: String,
enums: String,
defaults: true,
...
const cinemaProto = grpc.loadPackageDefinition(cinemaProtoDefinition).cinema;
// Implémenter le service de séries TV
const cinemaService = {
getcinema: (call, callback) => {
...
server.addService(cinemaProto.cinemaService.service, cinemaService);
const port = 50052;
